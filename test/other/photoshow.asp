...
.box li{float:left;width:350px;height:205px;padding:6px;background:#fff;border:1px solid #c3c3c3;display:inline;margin:15px 0 0 15px;list-style:none;}
.box li img{float:left;width:350px;height:205px;}
...
window.onload = function ()
{
 ...
 var i = 0;
 //生成图片数据
 for (i = 0; i < 6; i++) aData[aData.length] = "picture/" +"00"+ (1+i) + ".jpg";
 //循环创建多个实例
...
<body>
<div class="box">
    <h2 class="title"><span>参观游览</span><a style="color:#333;" href="javascript:;" class="order">换一换</a></h2>
    <ul></ul>
</div>
